...
void ADC_SAR_1_Enable(void)
{
    ...
    tmpReg = ADC_SAR_1_SAR_CSR3_REG;
        ...
        tmpReg &= ~ADC_SAR_1_SAR_PWR_CTRL_VREF_DIV_BY4;
    #endif /* CY_PSOC5A */
    ...
    #if((ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VSSA_TO_VDDA) || \
        (ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDDA_2_DIFF))
        tmpReg |= ADC_SAR_1_SAR_EN_RESVDA_EN;        /* Set bit for VDD/2 mode */
    #else
        tmpReg &= ~ADC_SAR_1_SAR_EN_RESVDA_EN;
...
void ADC_SAR_1_Stop(void)
{
    ...
    ADC_SAR_1_SAR_CSR0_REG &= ~ADC_SAR_1_SAR_SOF_START_CONV;
        ...
        ADC_SAR_1_SAR_CSR6_REG &= ~ADC_SAR_1_INT_BYPASS_EXT_VREF;
        /* Disable reference buffer and reduce the reference power to the minimum */
        ADC_SAR_1_SAR_CSR3_REG &= ~ADC_SAR_1_SAR_EN_BUF_VREF_EN; /* VCM buffer is absent in PSOC5A*/
