...
#define CY_CFG_BASE_ADDR_COUNT 31
typedef struct
{
	uint8 offset;
	uint8 value;
...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)0x4800007C)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480006FC)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000704)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000710)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000718)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000724)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG24((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x180138);
	CY_SET_XTND_REG24((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x180257);
	CY_SET_XTND_REG24((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x190BB7);
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_PM_ACT_CFG2), ((CY_GET_XTND_REG8(CYREG_PM_ACT_CFG2) | 0x0F)));
...
void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8(CYREG_SAR1_CSR1, 0x60);
	CY_SET_XTND_REG8(CYREG_SC2_SW0, 0x20);
	CY_SET_XTND_REG8(CYREG_SC2_SW8, 0x10);
	CY_SET_XTND_REG8(CYREG_SAR1_SW0, 0x10);
	CY_SET_XTND_REG8(CYREG_SAR1_SW3, 0x20);
	CY_SET_XTND_REG8(CYREG_BUS_SW0, 0x10);
