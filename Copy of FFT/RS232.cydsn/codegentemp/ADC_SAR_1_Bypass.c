...
#if !(CY_PSOC5A &&\
	 ADC_SAR_1_Bypass__PORT == 15 && (ADC_SAR_1_Bypass__MASK & 0xC0))
...
{
    uint8 staticBits = ADC_SAR_1_Bypass_DR & ~ADC_SAR_1_Bypass_MASK;
    ADC_SAR_1_Bypass_DR = staticBits | ((value << ADC_SAR_1_Bypass_SHIFT) & ADC_SAR_1_Bypass_MASK);
}
